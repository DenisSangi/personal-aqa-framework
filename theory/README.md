...
- [selenide-basics-and-generics.md](selenide-basics-and-generics.md) — Selenide-основы (`$`/`$x`, `SelenideElement`, ленивый браузер), self-bounded generics (CRTP) на изолированном примере `Animal`/`Dog`, связь с Template Method. Опора для [P3-T1](../curriculum/P3-T1-base-element-input.md).
